...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('collectionSet.view') }}">
            <i class="fas fa-fw fa-chart-area"></i>
            <span>Collection Set</span></a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('lensPower.index') }}">
            <i class="fas fa-fw fa-chart-area"></i>
            <span>Lens Power</span></a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('product.accessories') }}">
            <i class="fas fa-fw fa-chart-area"></i>
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('duration.index') }}">
            <i class="fas fa-fw fa-chart-area"></i>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('return.admin.index') }}">
                    <i class="menu-icon fa fa-dot-circle">@lang('Returend Products')</i></a>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('banner.view') }}">

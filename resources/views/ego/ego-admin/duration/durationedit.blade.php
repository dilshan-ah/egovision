            ...
            <div class="card-body">
                <form action="{{ route('duration.update', $duration->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6">
                            <label>Months (number of months)</label>
                            <input type="number" class="form-control" name="month"
                                placeholder="please enter duration month...." value="{{ $duration->months }}">
                            @error('name')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <img src="{{asset($duration->image_path)}}" style="width: 200px; height: auto;" alt=""></div>
                        </div>

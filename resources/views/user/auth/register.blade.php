                    ...
                    <div class="card-body bg-light">
                        <form action="{{ route('user.register') }}" method="POST" class="verify-gcaptcha">
                            ...
                            <div class="form-group">
                                ...
                                <label>@lang('I agree with')</label> <span>@foreach($policyPages as $policy) <a href="{{ route('policy.pages',[$policy->id, slug($policy->data_values->title)]) }}">{{ __($policy->data_values->title) }}</a> @if(!$loop->last), @endif @endforeach</span>
